...
public class EmptyTableFragment extends Fragment {
    ...
    int idkv = 0 ;
    FrameLayout frameEmptyTable;
    public EmptyTableFragment(int makv,ArrayList<BanAn> BANAN) {
    ...
    public void ThemButtonVaoTable(int top,int left,int i,String trangthai)
    {
        ...
        frameEmptyTable.addView(btnBan);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        frameEmptyTable = (FrameLayout) view.findViewById(R.id.frameEmptyTable);
        frameEmptyTable.removeAllViews();
        int topmargin = 40;
        int leftmargin = 40;
        int checkindex = 1;
        ...
        if(checkNumberOfTable==checkNumberAdd)
        {
            ...
            frameEmptyTable.addView(textViewthongbao);
        }
        return view;
    }
}